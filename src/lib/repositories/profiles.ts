...
export const PROFESSOR_FIELDS: ProfileField<ProfessorRow>[] = [
  {
    key: "title",
    label: "Title",
    hint: "Associate Professor of Historical Theology",
    scored: true,
  },
  ...
  { key: "phone", label: "Phone", type: "tel", scored: true },
  {
    key: "office_hours",
    label: "Office hours",
    hint: "Tuesdays 2–4 p.m., or by appointment",
    scored: true,
  },
  {
    key: "photo_url",
    label: "Photo URL",
    type: "url",
    hint: "No file upload is connected, so this takes a link. Left blank, your initials are used.",
  },
  ...
  { key: "research_areas", label: "Research areas", long: true, scored: true },
  {
    ...
    label: "Credentials",
    long: true,
    hint: "Degrees and where they were taken",
    scored: true,
  },
  {
  ...
  },
  {
    ...
    long: true,
    hint: "How students should book time with you. No calendar system is connected — this is read by people.",
    scored: true,
  },
];
...
export const STUDENT_FIELDS: ProfileField<StudentRow>[] = [
  ...
  },
  {
    key: "legal_name",
    label: "Legal name",
    hint: "Only if it differs from your preferred name",
    scored: true,
  },
  { key: "email", label: "Email", type: "email", scored: true },
  { key: "student_id_number", label: "Student ID", scored: true },
  {
    key: "program",
    label: "Program",
    hint: "Master of Divinity, for example",
    scored: true,
  },
  ...
  },
  {
    key: "timezone",
    label: "Time zone",
    hint: "So times shown to you make sense",
    scored: true,
  },
  { key: "church", label: "Church", long: true, scored: true },
  {
    key: "ministry",
    label: "Ministry context",
    long: true,
    hint: "Where the work you are training for happens",
    scored: true,
  },
  {
    ...
    long: true,
    hint: "How you study best. Read by your professor, not by an algorithm.",
    scored: true,
  },
  {
    ...
    long: true,
    hint: "Anything that would make the course more usable for you.",
    scored: true,
  },
  {
    ...
    long: true,
    hint: "Recorded for when notifications are built. Nothing is sent today.",
    scored: true,
  },
];
...
export function updateProfessorProfile(
  ...
  applyUpdate("professors", professorId, patch, [
    "name",
    ...PROFESSOR_FIELDS.map((f) => f.key),
  ]);
}
...
export function updateStudentProfile(
  ...
  applyUpdate("students", studentId, patch, [
    "name",
